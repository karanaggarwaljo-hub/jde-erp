    ...
    items: {
      ...
      items: {
        ...
        properties: {
          ...
          compatibility: { ...NULLABLE_STRING, description: 'Which machine or model this part fits, when the document states it — an Application/Model/Suitable For column, or a heading above the rows such as "JCB 3DX" or "BS4". Copy it as printed. Null if the document does not say; never infer it from the part name.' },
        ...
        required: ['name', 'part_number', 'oem_number', 'brand', 'category', 'hsn_code', 'compatibility', 'qty', 'cost_price', 'sale_price', 'mrp'],
      },
    },
  },
  required: ['items'],
